...
export const widgetManifestSchema = z.object({ scenePack: z.object({ id: z.string().optional(), recommendedViews: z.array(viewTypeSchema), recommendedTemplateIds: z.array(z.string()).optional(), nodeTypes: z.array(z.object({ key: z.string(), label: z.string(), defaultContentKind: contentKindSchema, allowedContentKinds: z.array(contentKindSchema) })), edgeTypes: z.array(z.object({ key: z.string(), label: z.string(), directed: z.boolean().optional() })).default([]) }), views: z.array(z.object({ viewId: z.string(), viewName: z.string(), viewType: viewTypeSchema, layoutRevision: z.number(), templateRef: z.object({ id: z.string(), version: z.string() }).optional() })).optional() });
