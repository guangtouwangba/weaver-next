import { ArrowLeft, FileText, ImagePlus, Link2, LayoutTemplate, Lock, MoreHorizontal, Pin as PinIcon, Plus, RotateCcw, Sparkles, Unlock, Library } from "lucide-react";
