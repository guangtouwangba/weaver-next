...
1. Read the explicit ChangeSet or LayoutRun id from the conversation or widget task.
...
5. Apply only after the user's permission level and explicit request allow it.
