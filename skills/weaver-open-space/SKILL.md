...
6. Use `weaver_list_project_views` when the user asks what Views exist. Historical and unpinned Views remain discoverable through the View Library even when they are not visible in the top switcher.
