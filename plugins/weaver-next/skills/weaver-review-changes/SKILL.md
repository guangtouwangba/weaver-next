...
1. Call `weaver_get_bound_canvas`, then read the explicit ChangeSet or LayoutRun id from the conversation or widget task. Stop if the current Chat binding is missing, offline, or stale.
