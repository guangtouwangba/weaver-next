...
4. Call `weaver_open_space` with the explicit workspace and project id. This creates or replaces the current Chat's binding; a forked Chat does not inherit it.
